...
/**
 * Generic (form) button for AiGenerations entity.
 */
class GenericButton
{
    /**
    ...
    /**
     * Get AiGenerations entity id.
     *
     * @return int
     */
    public function getAiGenerationsId(): int
    {
        return (int)$this->context->getRequest()->getParam(AiGenerationsInterface::AI_GENERATIONS_ID);
    }
